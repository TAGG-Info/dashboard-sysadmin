...
function PRTGLogo({ size, colored }: { size: number; colored: boolean }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 166.446 130.297" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M106.062 69.168a83.2 83.2 0 0 0-56.58 22.273l14.058 15.972q-.68.449-1.345.914A58.04 58.04 0 0 1 95.47 97.841c18.162.001 34.756 8.441 45.516 22.037 8.307-9.191 16.743-18.52 23.854-26.386a83.2 83.2 0 0 0-58.777-24.324"
        fill={orange}
      ...
      <path
        d="m41.29 184.952-35.564.02c-2.142 12.892-8.613 24.66-18.29 33.441a58.04 58.04 0 0 1-23.945 13.03l6.203 31.806a83.13 83.13 0 0 0 44.338-20.686 83.2 83.2 0 0 0 27.262-57.61z"
        fill={pink}
        transform="rotate(-47.853 -89.352 -8.877)"
      />
      <path
        d="M49.493 91.451c-16.976 15.728-26.66 37.78-26.681 60.922.004 16.815 5.165 33.233 14.686 47.092l12.026-8.161c-7.83-10.147-12.138-22.6-12.147-35.417a58.05 58.05 0 0 1 26.173-48.465z"
        fill={green}
        transform="translate(-22.812 -69.168)"
      />
    </svg>
